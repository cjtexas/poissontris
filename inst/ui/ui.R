    ...
    fluidRow(
        ...
        column(3,
            ...
            fluidRow(
              ...
              column(12, 
                    uiOutput("s2", style="height:70%;"), style="position:absolute; height:100%; width:100%; max-width:85vw;"),
                column(12, 
                    uiOutput("s3", style="height:70%;"), style="position:absolute; height:100%; width:100%; max-width:85vw;"), 
                column(12, 
                    uiOutput("s4", style="height:70%;"), style="position:absolute; height:100%; width:100%; max-width:85vw;"),
                column(12, 
                    uiOutput("s1", style="height:70%;"), style="z-index:-1; height:100%; width:100%; max-width:85vw;"),
                column(12,
                       fluidRow(
                         style = "height:30%; max-width:85vw;",
                         column(3,
                                class = "col-xs-3",
